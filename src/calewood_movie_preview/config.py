...
class Settings(BaseSettings):
    ...
    calewood_api_archived_statuses: str = Field(default="done,my-pre-archiving,mine", alias="CALEWOOD_API_ARCHIVED_STATUSES")
    calewood_api_list_status: str = Field(default="my-archiving", alias="CALEWOOD_API_LIST_STATUS")
